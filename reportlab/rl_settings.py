...
defaultGraphicsFontName = (
    "Times-Roman"  # initializer for STATE_DEFAULTS in shapes.py
)
...
longTableOptimize = (
    1  # default do use Henning von Bargen's long table optimizations
)
...
imageReaderFlags = (
    0  # attempt to convert images into internal memory files to reduce
)
...
canvas_baseColor = (
    None  # initialize the canvas fill and stroke colors if this is set
)
ignoreContainerActions = (
...
rtlSupport = (
    0  # set to 1 to attempt import of RTL assistance eg fribidi etc etc
)
...
strikeWidth = ""
strikeOffset = (
    "0.25*F"  # fraction of fontSize from baseline to draw strike through at.
)
...
embeddedHyphenation = (
    0  # if true attempt hypenation of words with embedded hyphens
)
