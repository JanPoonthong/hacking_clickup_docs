    ...
    try:
        ...
        try:
            ...
            _renderPM.makeT1Font(
                fontName, f.face.findT1File(), f.encoding.vector, open_and_read
            )
        except:
    ...
    def drawCentredString(self, x, y, text, text_anchor="middle"):
        if self.fillColor is not None:
            ...
            if text_anchor == "end":
                ...
                x -= numericXShift(
                    text_anchor, text, textLen, self.fontName, self.fontSize
                )
...
def test(outDir="pmout", shout=False):
    ...
    for (drawing, docstring, name) in getAllTestDrawings(
        doTTF=hasattr(_renderPM, "ft_get_face")
    ):
        ...
        for k in E:
            ...
            try:
                ...
                if k == "pct":
                    ...
                    drawing.save(
                        formats=["py", "svg"], outDir=outDir, fnRoot=fnRoot
                    )
                else:
