...
class _BarcodeWidget(PlotArea):
    _attrMap = AttrMap(
        BASE=PlotArea,
        barStrokeColor=AttrMapValue(
            isColorOrNone, desc="Color of bar borders."
        ),
        barFillColor=AttrMapValue(
            isColorOrNone, desc="Color of bar interior areas."
        ),
        barStrokeWidth=AttrMapValue(isNumber, desc="Width of bar borders."),
        value=AttrMapValue(EitherOr((isString, isNumber)), desc="Value."),
        textColor=AttrMapValue(
            isColorOrNone, desc="Color of human readable text."
        ),
...
BarcodeI2of5 = _BCW(
    ...
    AttrMap(
        ...
        stop=AttrMapValue(
            isBoolean, desc="if we use start/stop symbols (default 1)"
        ),
    ),
...
BarcodeCode128 = _BCW(
    ...
    AttrMap(
        BASE=BarcodeI2of5,
        UNWANTED=("bearers", "checksum", "ratio", "checksum", "stop"),
    ),
...
BarcodeFIM = _BCW(
    ...
    AttrMap(
        BASE=_BarcodeWidget,
        barWidth=AttrMapValue(
            isNumber, """(float, default 1/32in): the bar width."""
        ),
        ...
        barHeight=AttrMapValue(
            isNumber, """(float, default 5/8in): The bar height."""
        ),
        quiet=AttrMapValue(
            isBoolean,
            """(bool, default 0):
