...
class QRCode:
    ...
    def makeImpl(self, test, maskPattern):
        ...
        self.modules = [
            [False] * self.moduleCount for x in range(self.moduleCount)
        ]
    ...
    def _dataPosIterator(self):
        cols = itertools.chain(
            range(self.moduleCount - 1, 6, -2), range(5, 0, -2)
        )
        rows = (
...
class QRPolynomial:
    ...
    def mod(self, e):
        ...
        num = [
            nn ^ QRMath.gexp(QRMath.glog(en) + ratio)
