...
class SlideBox(Widget):
    ...
    _attrMap = AttrMap(
        labelFontName=AttrMapValue(
            isString, desc="Name of font used for the labels"
        ),
        labelFontSize=AttrMapValue(
            isNumber, desc="Size of font used for the labels"
        ),
        labelStrokeColor=AttrMapValue(
            isColorOrNone, desc="Colour for for number outlines"
        ),
        labelFillColor=AttrMapValue(
            isColorOrNone, desc="Colour for number insides"
        ),
        ...
        triangleHeight=AttrMapValue(
            isNumber, desc="Height of indicator triangles"
        ),
        triangleWidth=AttrMapValue(
            isNumber, desc="Width of indicator triangles"
        ),
        triangleFillColor=AttrMapValue(
            isColor, desc="Colour of indicator triangles"
        ),
        ...
        background=AttrMapValue(
            isColorOrNone,
            desc="Colour of the background to the drawing (if any)",
        ),
        sourceLabelText=AttrMapValue(
            isNoneOrString,
            desc="Text used for the 'source' label (can be empty)",
        ),
        sourceLabelOffset=AttrMapValue(
            isNumber, desc="Padding at bottom of drawing"
        ),
        ...
        sourceLabelFillColor=AttrMapValue(
            isColorOrNone,
            desc="Colour ink for the 'source' label (bottom right)",
        ),
    )
