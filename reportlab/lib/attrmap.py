...
class AttrMapValue:
    ...
    def __init__(
        self, validate=None, desc=None, initial=None, advancedUsage=0, **kw
    ):
            ...
            if isinstance(BASE, AttrMap):
                ...
                for B in BASE:
                    ...
                    if am is not self:
                        ...
                        raise ValueError(
                            "BASE=%s has wrong kind of value" % ascii(B)
                        )
...
def addProxyAttribute(
    src, name, validate=None, desc=None, initial=None, dst=None
):
    """
